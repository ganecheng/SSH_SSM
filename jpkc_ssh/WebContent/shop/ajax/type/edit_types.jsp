...
<script type="text/javascript">
	$(function()
	{
		...
		$("#submit_goods_type_picture_button").click(function()
		{
			...
			$.ajax(
			{
				...
				data :
				{
					'courseInfo.courseId' : custom_type_id,
					'courseInfo.videoMp4' : course_video_mp4,
					'courseInfo.videoFlv' : course_video_flv,
					'courseInfo.doc1' : course_doc_1,
					'courseInfo.doc2' : course_doc_2,
					'courseInfo.doc3' : course_doc_3,
					'courseInfo.doc4' : course_doc_4,
				},
	...
	function add_grade_1_node()
	{
		...
		{
			"course.courseName" : type_name_str
		}, function(json)
		{
	...
	function add_grade_2_node()
	{
		...
		if (zTree.getSelectedNodes()[0])
		{
			...
			{
				"course.courseName" : type_name_str,
				"course.courseParentId" : zTree.getSelectedNodes()[0].id
			}, function(json)
			{
				if (json.success == false)
				{
