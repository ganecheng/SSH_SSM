...
<div>
	...
	<div class="lefter">
		<div class="logo">
			<h3>
				<a href="${basePath }admin/admin_home">
					<strong>精品课程<br>后台管理
					</strong>
				</a>
			</h3>
...
<script type="text/javascript">
	...
	$.post("goods_type/get_shop_goods_type_level_one",
	{
		"commonStr" : "${shopSession.shopId }"
	}, function(json)
	{
		if (json.success == true)
		{
			...
			{
				var str = '<li>';
				str += '<a href="javascript:void(0)" class="sub_tag_a_link" id="sub_see_a_pic_' + n.goodsTypeId + '" data-url="shop/show_a_pic_info_list?type=' + n.goodsTypeId + '">' + n.goodsTypeName + '广告(1140x120)</a>';
				str += '</li>';
				$("#a_pic_shop_ul").append(str);
			});
		}
	},
	//返回类型
